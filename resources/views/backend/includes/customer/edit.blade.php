...
@section('title', __('Edumu-Lite') . ' | ' . __('Edit Users'))
...
@section('content')
    {{ html()->modelForm($content, 'PATCH', route('admin.customer.editcustomerpost', $content->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('Ebook')
                        <small class="text-muted">@lang('Edit User')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
