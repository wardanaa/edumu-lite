...
@section('title', __('Edumu-Lite') . ' | ' . __('Create Content Category'))
...
@section('content')
    {{ html()->form('POST', route('admin.category.create_post_category'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('Create Content Category')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
